...
const (
	FieldService_Create_FullMethodName              = "/new_object_builder_service.FieldService/Create"
	FieldService_GetByID_FullMethodName             = "/new_object_builder_service.FieldService/GetByID"
	FieldService_GetAll_FullMethodName              = "/new_object_builder_service.FieldService/GetAll"
	FieldService_GetAllForItems_FullMethodName      = "/new_object_builder_service.FieldService/GetAllForItems"
	FieldService_Update_FullMethodName              = "/new_object_builder_service.FieldService/Update"
	FieldService_UpdateSearch_FullMethodName        = "/new_object_builder_service.FieldService/UpdateSearch"
	FieldService_Delete_FullMethodName              = "/new_object_builder_service.FieldService/Delete"
...
func (c *fieldServiceClient) FieldsWithRelations(ctx context.Context, in *FieldsWithRelationRequest, opts ...grpc.CallOption) (*FieldsWithRelationsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FieldsWithRelationsResponse)
	err := c.cc.Invoke(ctx, FieldService_FieldsWithRelations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FieldService_FieldsWithRelations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FieldsWithRelationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FieldServiceServer).FieldsWithRelations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FieldService_FieldsWithRelations_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FieldServiceServer).FieldsWithRelations(ctx, req.(*FieldsWithRelationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FieldService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "new_object_builder_service.FieldService",
